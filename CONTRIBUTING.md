...
The package has **zero runtime dependencies** and must stay that way: `pfd/` may
...
`pfd/render/_vendored_symbols.py` is **generated**, and its own docstring says
...
independently. They all call into `pfd/portgeom.py`, the single source of truth
