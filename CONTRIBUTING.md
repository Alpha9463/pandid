...
committed *rendered* output. Regenerate them to record the release version:
...
fixtures need no update: `normalize` in `tests/_svg_compare.py` removes the
provenance block from both golden and gallery comparisons.
