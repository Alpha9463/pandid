...
- **229 registered symbols** with style variants, so a heat exchanger can be
...
with 75 equipment classes over them — a `GearPump` *is* a `Pump`.

A variant is a drawing within a class, picked with `variant=`. 132 of the 229
