...
def main():
    ...
    # balloon radially and lands square on the next one. Signal and not impulse:
    # the impulse line on this loop is V-101's, up to LT-101, and a balloon hung
    # off another balloon carries a measurement rather than a fluid, so
    # everything above the transmitter is drawn as signal. BS ISO 15519-1 §12.1
