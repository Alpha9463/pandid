...
The gallery is generated -- twelve examples rendered to SVG and rasterised to
...
**Why the whole gallery, on every push.** Rendering all twelve sheets costs
about 4.5 s, nearly all of it example 11 -- measured, not assumed. That is small
...
def rendered():
    ...
    every test below wants all of it: rendered per-test it would be twelve
    renders a test rather than twelve in total.
    """
